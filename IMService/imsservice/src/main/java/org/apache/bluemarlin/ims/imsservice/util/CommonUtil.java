...
public class CommonUtil
{
     ...
     * @return
     */
    public static Integer determinePriceCat(double price, TargetingChannel.PriceModel priceModel)
    {
        if (price < 0)
        {
            return 0;
        ...
        if (priceModel == TargetingChannel.PriceModel.CPM)
        {
            return determinePriceCatForCPM(price);
        }
        else if (priceModel == TargetingChannel.PriceModel.CPC)
        {
            return determinePriceCatForCPC(price);
        }
        else if (priceModel == TargetingChannel.PriceModel.CPD)
        {
            return determinePriceCatForCPD(price);
        }
        else if (priceModel == TargetingChannel.PriceModel.CPT)
        {
