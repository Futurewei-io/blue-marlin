...
class TestTopNSimilarityTableGenerator(unittest.TestCase):
    ...
    def test_run(self):
        ...
        df = util.load_df(self.hive_context, top_n_table)
        df.show()
    ...
    def validate_similarity_table (self, df):
        data = [
            ...
            ('0000003', [{'did':'0000001', 'score':1.73205081}, {'did':'0000003', 'score':1.73205081}, {'did':'0000004', 'score':0.88532267}, {'did':'0000002', 'score':0.66903623}], 1),
            ('0000004', [{'did':'0000004', 'score':1.73205081}, {'did':'0000002', 'score':1.50844401}, {'did':'0000001', 'score':0.88532267}, {'did':'0000003', 'score':0.88532267}], 1)
        ]
